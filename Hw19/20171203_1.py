...
def main():
    ...
    Model = Sequential()
    Model.add(Dense(1000, activation='tanh', input_shape=(784,),kernel_initializer=keras.initializers.glorot_normal(seed=None)
))
    Model.add(Dense(1000, activation='tanh',kernel_initializer=keras.initializers.glorot_normal(seed=None)
))
    Model.add(Dense(2, activation='sigmoid',kernel_initializer=keras.initializers.glorot_normal(seed=None)))
    Model.summary()
